...
- `src/js/background/pomodoro/initializer.js` owns Pomodoro background startup, idle detection startup through `src/platform/chrome/idle.js`, alarm wakeups through `src/platform/chrome/alarms.js`, and runtime message routing through `src/platform/chrome/runtime.js`.
