...
- `src/js/options/plans/actionEditor.js` owns the compact plan Actions tab that creates and lists simple plan-owned triggered action chains backed by existing UI cleanup rules, including trigger-source and keyword/structural-token filters.
