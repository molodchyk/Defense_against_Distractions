...
- `src/js/content/triggered-actions/runner.js`: current-page triggered-action execution against existing UI rule targets before the normal block overlay.
