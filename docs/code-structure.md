...
- `src/platform/chrome/runtime.js` owns runtime install/startup/message listener registration, manifest lookup, extension URL generation, and Options-page opening.
