...
This document contains copy-ready text for the Chrome Web Store privacy and permission form.
...
Defense Against Distractions does not use remote JavaScript or WebAssembly code. All extension code is included in the packaged extension.
...
Use this URL after `PRIVACY.md` is pushed to GitHub:
