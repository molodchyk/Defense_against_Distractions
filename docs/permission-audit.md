...
- API evidence: `src/platform/chrome/storage.js`, `src/js/content/state.js`, `src/features/content-blocking/blocked-page/chromeApi.js`, `src/js/options/password/manager.js`.
