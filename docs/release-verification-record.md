...
| --- | --- |
| `npm test` | Covered by `npm run verify:release`; 402 unit tests passed on 2026-07-03. |
...
| `npm run verify:research` | Passed directly and through `npm run verify:release`; 3 answered research syntheses verified. |
