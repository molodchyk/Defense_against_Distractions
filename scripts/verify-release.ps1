...
$requiredSourceEntries = @(
  ...
  "scripts/chrome-web-store-api.ps1",
  ...
  "scripts/playbook/store/automation.mjs",
  "scripts/playbook/store/mediaReview.mjs",
  "scripts/playbook-utils.mjs",
  "scripts/research/briefs.mjs",
  "scripts/research/evidence.mjs",
  "scripts/research/registry.mjs",
  "scripts/verify-package-output.ps1",
  "scripts/verify-release.ps1",
  "test/scripts/chrome-web-store-api-script.test.js",
  "research/README.md",
