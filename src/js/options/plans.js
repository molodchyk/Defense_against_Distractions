...
import { getScheduleActivityCounts, isCurrentTimeInAnySchedule, timeStringToMinutes } from '../shared/scheduleTime.js';
...
function getPlanMessage(key, fallbackOrSubstitutions, maybeSubstitutions) {
  return resolvePlanMessage(key, fallbackOrSubstitutions, maybeSubstitutions);
}
...
function createPlanFactList(plan) {
