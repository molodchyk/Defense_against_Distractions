...
describe('popup markup', () => {
  ...
  it('shows audible media and current-page keyword ideas in Page Signals', () => {
    ...
    assert.match(popupHtml, /selectedTextQuickAddActionSelect[\s\S]+popupQuickAddKeywordOnlyOption[\s\S]+popupQuickAddBlockPageOption[\s\S]+elementPickerHideImagesActionOption[\s\S]+elementPickerDisableControlsActionOption[\s\S]+popupQuickAddActionChainOption/);
